...
import Farida from "./img/farida.jpeg"; 
        ...
        <div className="meet_div">
          ...
          <div>
            <div className="team_card rounded">
              ...
              <h4>Farida Momoh</h4>
              <div className="socials">
                <a href="mailto:farimomoh@gmail.com" target="_blank">
                  <ion-icon name="mail-outline" className="icon"></ion-icon>
                </a>
                <a
                  href="https://www.linkedin.com/in/farida-momoh/"
                  target="_blank"
                >
                  <ion-icon name="logo-linkedin" className="icon"></ion-icon>
                </a>
                ...
                <a href="https://github.com/KimFarida" target="_blank">
                  <ion-icon name="logo-github" className="icon"></ion-icon>
                </a>
              </div>
            </div>
